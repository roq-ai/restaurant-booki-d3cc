  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine: Empowering eateries with seamless table reservations and menu management, enhancing customer experience and boosting efficiency."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine: Empowering eateries with seamless table reservations and menu management, enhancing customer experience and boosting efficiency.`}
            </Text>
            <Box
